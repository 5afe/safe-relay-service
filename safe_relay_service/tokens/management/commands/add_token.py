    ...
    def handle(self, *args, **options):
        ...
        for token_address in tokens:
            ...
            try:
                ...
                self.stdout.write(self.style.WARNING(f'Token {token.name} - {token.symbol} with address '
            ...
            try:
                ...
                if response == 'y':
                    Token.objects.create(address=token_address, name=info.name, symbol=info.symbol,
