...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if deployer_key:
            ...
            proxy_factory_address = safe_service.deploy_proxy_factory_contract(deployer_key=deployer_key)
            ...
            bulk_executor_address = safe_service.deploy_bulk_executor(deployer_key=deployer_key)
            ...
            proxy_factory_address = safe_service.deploy_proxy_factory_contract(deployer_account=deployer_account)
            ...
            oracle_registry_contract_address = safe_service.deploy_oracle_registry_contract(
                deployer_account=deployer_account, ds_feed_contract_address=ds_feed_contract_address)
            bulk_executor_address = safe_service.deploy_bulk_executor(deployer_account=deployer_account)
            ...
            proxy_factory_address = safe_service.deploy_proxy_factory_contract(deployer_account=account)
            ...
            oracle_registry_contract_address = safe_service.deploy_oracle_registry_contract(deployer_account=account,
                                                                                            ds_feed_contract_address=ds_feed_contract_address)
            bulk_executor_address = safe_service.deploy_bulk_executor(deployer_account=account)
