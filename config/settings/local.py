...
ALLOWED_HOSTS = env('ALLOWED_HOSTS', default="localhost,0.0.0.0,127.0.0.1,gnosis.kovan.augur.net").split(",")
...
SAFE_AUTO_FUND = env.bool('SAFE_AUTO_FUND', default=True)
SAFE_AUTO_APPROVE_TOKEN = env.bool('SAFE_AUTO_APPROVE_TOKEN', default=True)
