...
class TestSafeService(TestCase, TestCaseWithSafeContractMixin):
    ...
    def test_send_multisig_tx(self):
        ...
        # The balance we will send to the safe3
    ...
    def test_send_multisig_tx_gas_token(self):
        # Create safe3 with one owner, fund the safe3 and the owner with `safe_balance`
        ...
        # Give erc20 tokens to the safe3
        ...
        # Token was used for tx gas costs. Sender must have some tokens now and safe3 should have less
        ...
        # All ether on safe3 was transferred to receiver
